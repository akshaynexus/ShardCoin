...
#if defined(NDEBUG)
# error "DV7Coin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "DV7Coin Signed Message:\n";
...
#ifdef ENABLE_WALLET
// DV7Coin: attempt to generate suitable proof-of-stake
