...
QMAKE    = /usr/bin/qmake
Shard-Qt.xcodeproj/project.pbxproj: DV7Coin-qt.pro  /usr/local/Qt4.8/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
	...
	$(QMAKE) -o Shard-Qt.xcodeproj/project.pbxproj DV7Coin-qt.pro
